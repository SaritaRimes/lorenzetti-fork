...
StatusCode RootStreamNtupleMaker::bookHistograms( EventContext &ctx ) const
{
  ...
  float cl_detaCentHotCell    = 0;
  float cl_dphiCentHotCell    = 0;
  float cl_detaCentCell       = 0;
  float cl_dphiCentCell       = 0;
  float cl_tofClus            = 0;
  ...
  tree->Branch("cl_detaCentHotCell"     , &cl_detaCentHotCell);
  tree->Branch("cl_dphiCentHotCell"     , &cl_dphiCentHotCell);
  tree->Branch("cl_detaCentCell"        , &cl_detaCentCell);
  tree->Branch("cl_dphiCentCell"        , &cl_dphiCentCell);
  tree->Branch("cl_tofClus"             , &cl_tofClus);
...
StatusCode RootStreamNtupleMaker::fillHistograms( EventContext &ctx ) const
{
  ...
  InitBranch( tree, "cl_detaCentHotCell"      , &cl_detaCentHotCell);
  InitBranch( tree, "cl_dphiCentHotCell"      , &cl_dphiCentHotCell);
  InitBranch( tree, "cl_detaCentCell"         , &cl_detaCentCell   );
  InitBranch( tree, "cl_dphiCentCell"         , &cl_dphiCentCell   );
  InitBranch( tree, "cl_tofClus"              , &cl_tofClus        );
  ...
  
  {
    ...
    cl_detaCentHotCell = clus->detaCentHotCell();
    cl_dphiCentHotCell = clus->dphiCentHotCell();
    cl_detaCentCell    = clus->detaCentCell();
    cl_dphiCentCell    = clus->dphiCentCell();
    cl_tofClus         = clus->tofClus();
